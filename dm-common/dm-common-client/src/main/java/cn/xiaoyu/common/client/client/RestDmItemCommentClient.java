...
public interface RestDmItemCommentClient {
    ...
    public DmItemComment getDmItemCommentById(@RequestParam("id") Long id) throws BizException;

    @PostMapping(value = "/getDmItemCommentListByMap")
    public List<DmItemComment> getDmItemCommentListByMap(@RequestParam Map<String, Object> param) throws BizException;

    @PostMapping(value = "/getDmItemCommentCountByMap")
    public Integer getDmItemCommentCountByMap(@RequestParam Map<String, Object> param) throws BizException;

    @PostMapping(value = "/qdtxAddDmItemComment")
    public Integer qdtxAddDmItemComment(@RequestBody DmItemComment dmItemComment) throws BizException;

    @PostMapping(value = "/qdtxModifyDmItemComment")
    public Integer qdtxModifyDmItemComment(@RequestBody DmItemComment dmItemComment) throws BizException;
}
