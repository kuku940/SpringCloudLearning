...
public interface RestDmTradeClient {
    ...
    public DmTrade getDmTradeById(@RequestParam("id") Long id) throws BizException;

    @PostMapping(value = "/getDmTradeListByMap")
    public List<DmTrade> getDmTradeListByMap(@RequestParam Map<String, Object> param) throws BizException;

    @PostMapping(value = "/getDmTradeCountByMap")
    public Integer getDmTradeCountByMap(@RequestParam Map<String, Object> param) throws BizException;

    @PostMapping(value = "/qdtxAddDmTrade")
    public Integer qdtxAddDmTrade(@RequestBody DmTrade dmTrade) throws BizException;

    @PostMapping(value = "/qdtxModifyDmTrade")
    public Integer qdtxModifyDmTrade(@RequestBody DmTrade dmTrade) throws BizException;
}
