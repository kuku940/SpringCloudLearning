...
public interface RestDmSchedulerSeatPriceClient {
    ...
    public DmSchedulerSeatPrice getDmSchedulerSeatPriceById(@RequestParam("id") Long id) throws BizException;

    @PostMapping(value = "/getDmSchedulerSeatPriceListByMap")
    public List<DmSchedulerSeatPrice> getDmSchedulerSeatPriceListByMap(@RequestParam Map<String, Object> param) throws BizException;

    @PostMapping(value = "/getDmSchedulerSeatPriceCountByMap")
    public Integer getDmSchedulerSeatPriceCountByMap(@RequestParam Map<String, Object> param) throws BizException;

    @PostMapping(value = "/qdtxAddDmSchedulerSeatPrice")
    public Integer qdtxAddDmSchedulerSeatPrice(@RequestBody DmSchedulerSeatPrice dmSchedulerSeatPrice) throws BizException;

    @PostMapping(value = "/qdtxModifyDmSchedulerSeatPrice")
    public Integer qdtxModifyDmSchedulerSeatPrice(@RequestBody DmSchedulerSeatPrice dmSchedulerSeatPrice) throws BizException;
}
