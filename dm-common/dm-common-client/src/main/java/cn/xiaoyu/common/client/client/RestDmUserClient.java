...
public interface RestDmUserClient {
    ...
    public DmUser getDmUserById(@RequestParam("id") Long id) throws BizException;

    @PostMapping(value = "/getDmUserListByMap")
    public List<DmUser> getDmUserListByMap(@RequestParam Map<String, Object> param) throws BizException;

    @PostMapping(value = "/getDmUserCountByMap")
    public Integer getDmUserCountByMap(@RequestParam Map<String, Object> param) throws BizException;

    @PostMapping(value = "/qdtxAddDmUser")
    public Integer qdtxAddDmUser(@RequestBody DmUser dmUser) throws BizException;

    @PostMapping(value = "/qdtxModifyDmUser")
    public Integer qdtxModifyDmUser(@RequestBody DmUser dmUser) throws BizException;
}
