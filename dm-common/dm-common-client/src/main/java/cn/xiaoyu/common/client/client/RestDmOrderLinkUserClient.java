...
public interface RestDmOrderLinkUserClient {
    ...
    public DmOrderLinkUser getDmOrderLinkUserById(@RequestParam("id") Long id) throws BizException;

    @PostMapping(value = "/getDmOrderLinkUserListByMap")
    public List<DmOrderLinkUser> getDmOrderLinkUserListByMap(@RequestParam Map<String, Object> param) throws BizException;

    @PostMapping(value = "/getDmOrderLinkUserCountByMap")
    public Integer getDmOrderLinkUserCountByMap(@RequestParam Map<String, Object> param) throws BizException;

    @PostMapping(value = "/qdtxAddDmOrderLinkUser")
    public Integer qdtxAddDmOrderLinkUser(@RequestBody DmOrderLinkUser dmOrderLinkUser) throws BizException;

    @PostMapping(value = "/qdtxModifyDmOrderLinkUser")
    public Integer qdtxModifyDmOrderLinkUser(@RequestBody DmOrderLinkUser dmOrderLinkUser) throws BizException;
}
